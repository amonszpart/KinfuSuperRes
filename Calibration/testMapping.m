...
dep8 = imread( 'dep8_00000015.pgm' );
subplot(121); imshow(dep8);
img8 = imread( 'img8_00000015.png' );
...
for x = 0 : 1 : dsize(2) - 1
    ...
    for y = 0 : 1 : dsize(1) -1
        ...
        if 1
            z = dep8(y+1, x+1);
            d = t_gamma( round(double(z) / 255.0 * 1093.0 + 1) );
...
img8(:,:,1) = mapped / 1093.0 * 255.0 * 2;
imwrite( 'mapped.png', 'mapped' );
